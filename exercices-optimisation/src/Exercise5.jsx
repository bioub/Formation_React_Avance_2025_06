...
function Exercise5() {
  ...
  const closestPrime = useMemo(() => {
    return findClosestLowestPrime(value);
  }, [value]);
  ...
  const render = (
    <div className="Exercise5">
      ...
      <p>
        ...
        problème de performance vient du composant <code>Exercise5</code>
      </p>
      <p>
      ...
      <p>
        ...
        issue comes from component <code>Exercise5</code>
      </p>
      <p>
      ...
      <div className="box">
        ...
        />
        the closest lowest prime to {value} is {closestPrime}
